               ...
               <div className="row">
                  <div className="col-lg-4 col-sm-6">
                     <div className="widget mb-30">
                        ...
                        <a href="https://www.linkedin.com/company/al-ebriez-global-capital-berhad/mycompany/" target="_blank"><i><FontAwesomeIcon icon={['fab', 'linkedin']} /></i></a>
                        ...
                        <a href="https://www.pinterest.com/EbreizGlobal/" target="_blank"><i><FontAwesomeIcon icon={['fab', 'pinterest-p']} /></i></a><br></br>
                        <a href="https://www.instagram.com/al.ebreiz.global.capital/" target="_blank"><i><FontAwesomeIcon icon={['fab', 'instagram']} /></i></a>
                       <a href="https://www.youtube.com/channel/UCyeEMWN-puUJvMorjyb_DvA" target="_blank"><i><FontAwesomeIcon icon={['fab', 'youtube']} /></i></a>
                           <a href="https://wa.link/iy5ooi" target="_blank"><i><FontAwesomeIcon icon={['fab', 'whatsapp']} /></i></a>
                           <a href="https://t.me/AlaDeenGold" target="_blank"><i><FontAwesomeIcon icon={['fab', 'telegram']} /></i></a>
                        </div>
                     </div>
                  </div>
