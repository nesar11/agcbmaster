                                            ...
                                            <div className="kblog swiper-slide">
                                                ...
                                                <div className="kblog-text">
                                                    ...
                                                    <h3 className="kblog-text-title mb-20">
                                                        <Link href="/blog-details"><a>Webinar Forum: Pelaburan Emas Digital Mengikut Perspektif Islam</a></Link>
                                                    </h3>
                                        ...
                                        <SwiperSlide>
                                            <div className="kblog swiper-slide">
                                                ...
                                                <div className="kblog-text">
                                                    ...
                                                    <h3 className="kblog-text-title mb-20">
                                                        <Link href="/blog-details"><a>Digital Currency Conference: The New Level of Currency</a></Link>
                                                    </h3>
                                                    <div className="kblog-text-link">
                                                        <Link href="/blog-details"><a>Read more <i><FontAwesomeIcon icon={['fas', 'chevron-right']} /></i></a></Link>
                                                    </div>
                                        ...
                                        <SwiperSlide>
                                            <div className="kblog swiper-slide">
                                                ...
                                                <div className="kblog-text">
                                                    ...
                                                    <h3 className="kblog-text-title mb-20">
                                                        <Link href="/blog-details"><a>DX Leaders Strategy Forum Malaysia: Digital Transformation in a Hybrid Future</a></Link>
                                                    </h3>
                                                    <div className="kblog-text-link">
                                                        <Link href="/blog-details"><a>Read more <i><FontAwesomeIcon icon={['fas', 'chevron-right']} /></i></a></Link>
                                                    </div>
                                        ...
                                        <SwiperSlide>
                                            <div className="kblog swiper-slide">
                                                ...
                                                <div className="kblog-text">
                                                    ...
                                                    <h3 className="kblog-text-title mb-20">
                                                        <Link href="/blog-details"><a>Forum: Pembentukan Perbankan Islam; Apa Kata Ahli Majlis Syariah?</a></Link>
                                                    </h3>
                                                    <div className="kblog-text-link">
                                                        <Link href="/blog-details"><a>Read more <i><FontAwesomeIcon icon={['fas', 'chevron-right']} /></i></a></Link>
                                                    </div>
