                                    ...
                                    <div className="row">
                                        <div className="col-lg-12">
                                            <div className="kslider z-index">
                                                <h5 className="kslider--subtitle mb-25" data-animation="fadeInUp" data-delay="0.3s">Welcome to ALEBREIZ</h5>
                                                <h2 className="kslider--title mb-40" data-animation="fadeInUp" data-delay="0.5s"> AlaDeen Gold</h2>
                                ...
                                <div className="container">
                                    <div className="row">
                                        <div className="col-lg-12">
                                            <div className="kslider z-index">
                                                <h5 className="kslider--subtitle mb-25" data-animation="fadeInUp" data-delay="0.3s">Welcome to ALEBREIZ</h5>
                                                <h2 className="kslider--title mb-40" data-animation="fadeInUp" data-delay="0.5s"> AlaDeen Jewelery</h2>
                                                <div className="kslider--btn" data-animation="fadeInUp" data-delay="0.7s">
                                                    <Link href="/service"><a className="theme-btn">Discover more</a></Link>
                                                </div>
                                            </div>
                                ...
                                <div className="container">
                                    <div className="row">
                                        <div className="col-lg-12">
                                            <div className="kslider z-index">
                                                <h5 className="kslider--subtitle mb-25" data-animation="fadeInUp" data-delay="0.3s">Welcome to ALEBREIZ</h5>
                                                <h2 className="kslider--title mb-40" data-animation="fadeInUp" data-delay="0.5s"> AlaDeen Silver</h2>
                                                <div className="kslider--btn" data-animation="fadeInUp" data-delay="0.7s">
                                                    <Link href="/service"><a className="theme-btn">Discover more</a></Link>
                                                </div>
                                            </div>
